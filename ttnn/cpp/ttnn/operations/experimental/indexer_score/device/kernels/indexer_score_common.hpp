...
// One partial causal tile per possible compressed-key residue, followed by one all--inf tile.
// ratio=1 preserves the legacy [diagonal, full] two-tile allocation; ratio=4 has four partial patterns.
