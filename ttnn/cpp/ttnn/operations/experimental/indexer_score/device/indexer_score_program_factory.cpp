...
IndexerScoreProgramFactory::cached_program_t IndexerScoreProgramFactory::create_at(
    ...
    // Common args: dimensions (including compressed-key ratio), then CB indices in CbArg order.
    // chunk_t remains a per-device runtime arg in query-token tile units.
