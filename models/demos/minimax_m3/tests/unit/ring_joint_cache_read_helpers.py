...
"""Shared fixtures for the ring_joint cache-read tests on (8,4): the GQA shapes, the block-cyclic chunk builders
and gather, the dense SDPA configs, and the 1-element uint32 scalars the metadata path reads on-device."""
